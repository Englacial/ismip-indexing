...
from ismip6_comparison_app.config_loader import get_config, load_metadata_yaml
...
**Est. load time:** {est_time}-{est_time*2} sec
    ...
    def handle_auto_range_toggle(*events):
        ...
        if state.auto_range and len(state.datasets) > 0:
            ...
            from ismip6_comparison_app.components.data_loader import calculate_global_ranges
